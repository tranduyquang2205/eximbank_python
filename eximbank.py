...
class EXIMBANK:
    ...
    def encrypt_data(self, data):
        url = "https://tcbcp.pay2world.org/eximbank/encrypt"
    ...
    def decrypt_data(self, cipher):
        url = "https://tcbcp.pay2world.org/eximbank/decrypt"
...
#             transactions_result = eximbank.get_transactions(account_number,from_date,to_date)
...
#                 otp = input("Enter OTP: ")
#                 verify_otp_result = eximbank.verify_otp(otp)
...
#                 check_confirm = eximbank.check_confirm_loop()
#                 # check_confirm = eximbank.check_confirm_loop()
#                 # print(check_confirm)
#                 if check_confirm["success"]:
...
#                     balance_result = eximbank.get_balance(account_number)
#                     print(balance_result)
#                     transactions_result = eximbank.get_transactions(account_number)
#                     print(transactions_result)
#                 else:
